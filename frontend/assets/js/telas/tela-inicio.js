...
class TelaInicio {
    ...
    constructor(jogo) {
        this.#jogo = jogo;
        this.manipularEventoBotaoClicado();
        this.#tela = document.getElementById('telaInicio'); 
        this.#elementoSelecionado = document.getElementById('botaoComecar');
    }
    ...
    processarAcaoBotao(botaoId) {
        switch (botaoId) {
            ...
            case 'botaoRegras':
                return this.exibirModal('modalRegras');
            
            case 'botaoPlacarInicio':
                this.carregarDadosPlacar();
                return this.exibirModal('modalPlacar');

            case 'botaoVoltarRegras':
    ...
    processarCursorNavegacao() {
        this.#navegacao = this.#modalAtivo 
            ...
            : document.getElementById('navegacaoInicio').querySelectorAll('.tela__botao');
    }
